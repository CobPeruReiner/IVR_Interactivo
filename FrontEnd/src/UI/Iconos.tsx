...
export function Off(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        d="M28 28.762c1.125 0 1.875-.82 1.875-1.992V5.723c0-1.196-.75-1.992-1.875-1.992s-1.9.796-1.9 1.992V26.77c0 1.171.774 1.992 1.899 1.992m0 23.508c12.727 0 23.297-10.547 23.297-23.274c0-6.914-3.117-13.195-8.016-17.46c-1.945-1.735-4.734 1.007-2.508 2.952c4.008 3.492 6.516 8.719 6.516 14.508c0 10.711-8.602 19.313-19.29 19.313a19.255 19.255 0 0 1-19.31-19.313a19.25 19.25 0 0 1 6.54-14.508c2.203-1.945-.587-4.687-2.508-2.953c-4.899 4.266-8.016 10.547-8.016 17.461C4.703 41.723 15.273 52.27 28 52.27"
      />
    </svg>
  );
}
...
export function ViewOff(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function Calls(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function LogOut(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M459 83c118 50 201 167 201 304c0 181-148 330-330 330C149 717 0 568 0 387C0 250 83 133 202 83v111C140 236 98 306 98 387c0 128 104 232 232 232s232-104 232-232c0-81-41-151-103-193zm-74 302V0H275v385z"
      />
    </svg>
  );
}

export function Roboto(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <path
          ...
          d="M21.444 15.44h-5v-.5l3.5-4h.5v6m-12.888-1.5h-5v-.5l3.5-4h.5v6"
        />
      </g>
    </svg>
  );
  ...
  return (
    ...
    >
      <g fill="currentColor">
        <path
          fillRule="evenodd"
          d="M1.685 6.659c-.926.309-.906 1.626.03 1.906l7.493 2.242l2.447 7.71c.293.922 1.596.932 1.902.013L18.86 2.62a1 1 0 0 0-1.265-1.265L1.685 6.66Zm3.633.897l11.012-3.67l-3.698 11.096l-1.677-5.284a1 1 0 0 0-.667-.655l-4.97-1.487Z"
          clipRule="evenodd"
        />
        <path d="m17.767 1.44l1.044 1.077l-8.828 8.543l-1.044-1.077l8.828-8.543Z" />
      </g>
    </svg>
  );
}

export function Operation(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <path
        fill="none"
        stroke="currentColor"
        d="M8 11.5h5.5v-9h-11v9zm0 0v2m0 0H5m3 0h3m-6.5-5l2.5-2L8.5 8l3-2.5"
      />
    </svg>
  );
}
